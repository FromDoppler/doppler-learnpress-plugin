...
/*
This class checks if the required dependencies for 
doppler for learnpress are installed and active.
*/

class Dependecy_Checker
{
    const _DEPENDENCIES = array(
        array('name'=>'LearnPress', 'repository'=>'https://wordpress.org/plugins/learnpress', 'plugin_dir' => 'learnpress/learnpress.php'),
